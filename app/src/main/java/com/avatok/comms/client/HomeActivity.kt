...
import com.avatok.comms.fragments.ContactPickerFragment
import com.avatok.comms.fragments.ConversationFragment
import com.avatok.comms.fragments.HomeFragment
...
import com.avatok.comms.utils.getUiCustomizationFromConfigJson
import com.avatok.comms.viewmodel.WelcomeJamiViewModel
import com.avatok.comms.views.AvatarDrawable
import com.avatok.comms.views.AvatarFactory.toAdaptiveIcon
import com.avatok.comms.views.twopane.TwoPaneLayout
...
class HomeActivity : AppCompatActivity(), ContactPickerFragment.OnContactedPicked {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (DeviceUtils.isTv(this)) {
            ...
            val intent = intent
            intent.setClass(this, com.avatok.comms.tv.main.HomeActivity::class.java)
            finish()

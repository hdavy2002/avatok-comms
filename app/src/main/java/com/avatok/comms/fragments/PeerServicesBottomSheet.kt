...
import com.avatok.comms.databinding.FragPeerServicesBinding
import com.avatok.comms.databinding.ItemPeerServiceBinding
import com.avatok.comms.viewmodel.PeerServicesUiState
import com.avatok.comms.viewmodel.PeerServicesViewModel
...
class PeerServicesBottomSheet : BottomSheetDialogFragment() {
    ...
    private fun copyToClipboard(text: String) {
        ...
        Toast.makeText(requireContext(), com.avatok.comms.R.string.peer_services_link_copied, Toast.LENGTH_SHORT).show()
    }
    ...
    private fun render(b: FragPeerServicesBinding, adapter: ServiceAdapter, state: PeerServicesUiState) {
        ...
        when {
            ...
            state.services.isEmpty() -> {
                b.textStatus.setText(com.avatok.comms.R.string.peer_services_empty)
                b.textStatus.isVisible = true
                b.recyclerServices.isVisible = false
            }
            else -> {
        ...
        inner class Holder(private val b: ItemPeerServiceBinding) : RecyclerView.ViewHolder(b.root) {
            fun bind(service: PeerServiceInfo, tunnel: TunnelInfo?, isPending: Boolean) {
                ...
                b.serviceIcon.imageTintList = if (connected) {
                    ContextCompat.getColorStateList(b.root.context, com.avatok.comms.R.color.green_400)
                } else {

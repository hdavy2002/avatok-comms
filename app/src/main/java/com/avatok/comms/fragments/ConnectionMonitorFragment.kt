...
import com.avatok.comms.databinding.FragConnectionMonitorBinding
import com.avatok.comms.databinding.ItemDeviceConnectionBinding
import com.avatok.comms.databinding.ItemListContactBinding
            ...
            val diff = DiffUtil.calculateDiff(object : DiffUtil.Callback() {
                ...
                override fun areContentsTheSame(oldItemPosition: Int, newItemPosition: Int): Boolean {
                    ...
                    return if (oldItem.contact != null && newItem.contact != null) {
                        ...
                        // force update of connection time on refresh
                        false
                    }
                }

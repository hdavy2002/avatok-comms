package com.avatok.comms.tv.cards;
...
public class CardView extends BaseCardView {
    ...
    private void buildImageCardView(AttributeSet attrs, int defStyleAttr, int defStyle) {
        ...
        Typeface mulishBold = ResourcesCompat.getFont(getContext(), com.avatok.comms.R.font.mulish_semibold);
        Typeface mulishRegular = ResourcesCompat.getFont(getContext(), com.avatok.comms.R.font.mulish_regular);
        ...
        if (hasContent) {
            ...
            mContentView.setTextColor(getResources().getColor(com.avatok.comms.R.color.white));

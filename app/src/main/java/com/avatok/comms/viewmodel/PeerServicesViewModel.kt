 ...
 */
package com.avatok.comms.viewmodel
            ...
            .subscribe { result ->
                if (result.status == PeerServicesStatus.OK) {
                    ...
                    val msg = context.getString(when (result.status) {
                        PeerServicesStatus.NO_DEVICES  -> com.avatok.comms.R.string.peer_services_error_offline
                        PeerServicesStatus.UNREACHABLE -> com.avatok.comms.R.string.peer_services_error_unreachable
                        PeerServicesStatus.TIMEOUT     -> com.avatok.comms.R.string.peer_services_error_timeout
                        else                           -> com.avatok.comms.R.string.peer_services_error_unknown
                    })
